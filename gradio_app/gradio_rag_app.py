...
import gradio as gr
import openai
from faiss_helper import load_or_build_index, BatchedPersistenceManager
import json
...
DOCS = {
    "What is RAG?": (
        "Retrieval‑Augmented Generation (RAG) combines LLMs with a retrieval"
        " component to ground answers in external data."
    ),
    "Who created Python?": (
...
INDEX: Optional[BatchedPersistenceManager] = None
